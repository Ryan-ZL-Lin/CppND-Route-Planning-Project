...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    RouteModel::Node* pointer_to_node_lowset_f = this->open_list.back();
    this->open_list.pop_back();
    return pointer_to_node_lowset_f;
}
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    if(current_node != this->end_node){
        std::cout << "ConstructFinalPath Failed, the initial node is not end node";
    }
    path_found.push_back(*current_node); // the current node should be the end node here
...
void RoutePlanner::AStarSearch() {
    ...
    if(current_node == this->end_node){
        ...
        std::cout << "Search Failed, unable to return the correct path";
    }
